<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medicos.aspx.cs" Inherits="MedicalApp.pages.Medicos" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" BackColor="#99CCFF" CssClass="boton_personalizado" />
        </div>
    </form>
</body>
</html>
